...
- **Research:** Use [NotebookLM](https://notebooklm.google.com/) to research the topics and understand the requirements.
- **Prompt Generation:** Ask NotebookLM to generate the specific prompt for Google's Firebase Studio to build this application.
...
- **Scraping:** Fetch the URL and extract specific metadata:
  ...
  - _Backup:_ Parse JSON-LD if available.
- **Validation:**
...
- **Gemini CLI:** Use the [Gemini CLI](https://github.com/google-gemini/gemini-cli) for AI-assisted development tasks.
  - **Installation:** `npm install -g @google/gemini-cli`
  - **Use Cases:**
    - Explaining complex code snippets.
    - Generating commit messages.
    - Quick refactoring and code improvements.
